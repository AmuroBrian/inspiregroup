  ...
  return (
    <div className="flex flex-col md:flex-row max-w-5xl mx-auto p-6">
      ...
      <div className="md:w-3/4 md:ml-auto">
        {/* Centered Image */}
        <SectionImage src="images/MicroInvestmentsNotTranslate.png" alt="Micro Investments" />
        
        {/* Introduction */}
        <p className="mt-4 text-lg justified-center">
          Micro Investment is a method of investing with a small amount of money. Conventional investments require a certain amount, but with microinvestments, even beginners and people who just started asset formation can easily participate.
        </p>

        {/* Sections */}
        <Section title="Characteristics of Microinvestments" name="characteristics">
        ...
        <SectionImage src="images/yesnoinvestment.png" alt="Investment Decision" />
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
          Inspire Holdings Inc. is a full-service consulting firm based in the Philippines. 
          The company provides professional consulting services for strategic business expansion and helps 
          companies effectively expand into new market conditions.
          </p>

          <p className="text-gray-700 text-lg leading-relaxed">
          Japan managers who have been involved in the Philippines for many years are now so 
          trusted and relied on by INSPIRE that they are inundated with requests.
          </p>

          <p className="text-gray-700 text-lg leading-relaxed">
          We are also focusing on precise marketing management, the evolution of smart cities using AI, 
          and the promotion of advanced technologies. The company's mission is to expand international 
          business from the Philippines, facilitate mergers and acquisitions, and be a pioneer in the 
          global entertainment business.
          </p>

          <p className="text-gray-700 text-lg leading-relaxed">
          Moreover, Inspire Holdings Inc. aims to go public by 2027 and plans to contribute to its vision 
          of making the Philippines a leader in Asia.
          </p>
          </div>
...
const characteristics = [
  { title: "Small Initial Investment", details: ["Start with a small amount.", "Beginner-friendly due to its low entry barrier."] },
  { title: "Utilization of Apps and Digital Platforms", details: ["Invest easily via smartphone apps.", "Many platforms offer fully online account setup."] },
  { title: "Emphasis on Recurring and Spare Change Investments", details: ["Automated investment of spare change from credit card transactions.", "Option for recurring, fixed-amount investments."] },
];

const services = [
  { title: "Domestic Services (Japan)", items: ["WealthNavi for TsumiTate", "THEO", "Toranoko (Spare Change Investment)"] },
  { title: "Overseas Services", items: ["Acorns (USA)", "Stash (USA)", "Raiz (Australia)"] },
];
