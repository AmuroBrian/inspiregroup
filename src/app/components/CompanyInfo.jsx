    ...
    <div className="p-8 w-full bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row gap-8 mt-8 items-center justify-center">
        {[
          ...
          <div
            key={index}
            className={`w-full md:w-1/3 md:h-full h-full flex flex-col items-center text-white font-bold p-8 text-center rounded-2xl bg-gradient-to-l from-[#09555C] to-[#004ff9] ${
