...
const Advertisement = () => {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gray-100 p-8">
      <h1 className="text-3xl md:text-4xl font-extrabold text-center w-full py-8">Business Services</h1>
      <div className="w-full flex flex-col md:flex-row items-center justify-center gap-8">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold mt-4">Inspire Wallet</h2>
          <p className="mt-2 max-w-sm text-white text-center text-sm md:text-base">
            Using just your smartphone, handle all your financial needs with ease.
          </p>
          ...
          <p className="mt-2 text-white text-center text-sm">Scan the QR Code and install</p>
        </div>
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold mt-4">Inspire Financial Products</h2>
          ...
          <p className="mt-2 text-white text-center text-sm">Your Investments are safe with us</p>
        </div>
        ...
        >
          ...
          <p className="mt-2 text-white text-center text-sm">Your travels are safer with us</p>
        </div>
      </div>
    </div>
  );
